...
function displayMessage() {
  ...
  console.log(MessageMixer.capitalizeFirstCharacterOfWords("What is the" +
      " color of the sky?"));
  ...
  console.log(MessageMixer.replaceFirstOccurence("What is the color of the" +
      " sky?", "sky", "water"));
  console.log(MessageMixer.encode("What is the color of the sky?"));
  console.log(MessageMixer.palindrome("whassup?"));
  console.log(MessageMixer.pigLatin("whassup man how are u?", '&'));
}
